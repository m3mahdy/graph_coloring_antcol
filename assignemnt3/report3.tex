...
\textbf{Note:} While several GCP variations exist in the literature—including Equitable Coloring Problem (ECP), Robust Graph Coloring Problem (RGCP), and Graph b-coloring Problem, this work focuses exclusively on the classical vertex coloring problem as defined above.\newline
