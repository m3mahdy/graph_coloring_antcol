...
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ant.png}
\end{figure}
\end{frame}
...
\begin{frame}{ Ant Colony Optimization for Graph Coloring}
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/graph_coloring_with_ants.png}
\end{figure}
\end{frame}
...
\begin{frame}{ Mechanism Components}
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/solutions_components.png}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/optuna.png}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/the3methods.png}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/ant_col.png}
\end{figure}
\end{frame}
